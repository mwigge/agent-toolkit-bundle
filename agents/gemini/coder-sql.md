...
- **`activate_skill("postgres-patterns")`** — index strategy, data types, RLS policies, UPSERT, pagination, anti-pattern detection, connection config
- **`activate_skill("python-architect")`** → database architecture section — parameterised SQL, connection pool via DI, migration conventions
