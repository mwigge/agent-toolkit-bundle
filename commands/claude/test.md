---
description: Generate and run tests for a target (file, function, or module), close coverage gaps, and report results.
argument-hint: <file / function / module to test>
---

# /test — Generate and Run Tests

Generate meaningful tests for the target and run them to green. Target: `$ARGUMENTS` (if empty, use the current diff / most recently changed files).
