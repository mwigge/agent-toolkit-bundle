---
description: Generate or update documentation for a target — README, module docs, API reference, docstrings, or ADR — matching the repo's existing style.
argument-hint: <file / module / feature to document> [doc type]
---

# /docs — Generate or Update Documentation

Produce accurate documentation for the target. Target and type: `$ARGUMENTS`.
